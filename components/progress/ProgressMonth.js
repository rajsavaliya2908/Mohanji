...
const ProgressWeek = ({ navigation }, props) => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://ethicallybased.com/mohanji-app-api/track-timer-get.php?duration=Monthly&presetId=&authToken=${authToken}`
      )
      .then((response) => {
        ...
        <View style={styles.containerInner}>
          ...
          <View style={styles.iconContainer}>
            <Image
              ...
              style={styles.icon}
            />
            <Text style={styles.subTitle}>{"Your Progress Last 30 Days"}</Text>
          </View>
          <LineChart
            data={graphData}
            width={width}
          ...
          <View style={styles.allRowsWrapper}>
            ...
            <View style={styles.rowEach}>
              <View style={styles.rowEachLeft}>
                <Text style={styles.rowEachLeftHeader}>
                  Days meditated in the last 30 days
                </Text>
              </View>
              <View style={styles.rowEachRight}>
            ...
            <View style={styles.rowEach}>
              <View style={styles.rowEachLeft}>
                <Text style={styles.rowEachLeftHeader}>
                  Time meditated in last 30 days
                </Text>
              </View>
              <View style={styles.rowEachRight}>
                <Text style={styles.rowEachRightText}>
