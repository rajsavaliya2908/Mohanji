...
const PastEvents = ({ navigation }, props) => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://ethicallybased.com/mohanji-app-api/get.php?type=events&direction=past&limit=10&showMore=0&pagination=0&pageStart=" +
          pageStart
      )
      .then((response) => {
        // Success
